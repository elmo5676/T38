...
func getDiversionData (numberOfEngines: String, pod: String, altitude: String, fuelStatus: String) -> Array<Any>{
    ...
    print(divertResult)
    /*
    print(divertResult[0])
    print(divertResult[1])
    print(divertResult[2])
    print(divertResult[3])
    print(divertResult[4])
    print(divertResult[5])
    print(divertResult[6])
    print(divertResult[7])
    */
    return(divertResult)
}

getDiversionData(numberOfEngines: "", pod: "", altitude: "", fuelStatus: "")

getDiversionData(numberOfEngines: "SEO", pod: "P", altitude: "10K", fuelStatus: "600")
...
func updateDisplay(){
    ...
    stayAtRangeLabel.text = divertResultArray[0]//stayAtRangeValue
    stayAtMachLabel.text = divertResultArray[1]//stayAtMachValue
    stayAtFuelFlowLabel.text = divertResultArray[2]//stayAtFuelFlowValue
    climbToAltitudeLabel.text = divertResultArray[4]//climbToAltitudeValue
    climbToRangeLabel.text = divertResultArray[3]//climbToRangeValue
    climbToMachLabel.text = divertResultArray[5]//climbToMachValue
    climbToFuelFlowLabel.text = divertResultArray[6]//climbToFuelFlowValue
    climbScheduleKCASLabel.text = climbScheduleKCASValue
    climbScheduleMachLabel.text = climbScheduleMachValue
    descendDistanceOutLabel.text = divertResultArray[7]//descendDistanceOutValue
    descendFuelRemainingLabel.text = divertResultArray[8]//descendFuelRemainingValue
...
func getFlameOutMach (flameOutAltitude: String, flameOutTemperature: String) -> String {
    ...
    print(flameOutResults)
    return(flameOutResults)
}

getFlameOutMach(flameOutAltitude: "40", flameOutTemperature: "-60")
